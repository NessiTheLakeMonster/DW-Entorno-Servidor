...
class ProfesorFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'cargo' => $this->faker->randomElement([
                ...
                'jefe de estudios',
                'tutor',
                'guardián de la luz de Ellendhil'
            ]),
    ...
    /**
     * 'afterMaking' se utiliza para definir acciones que se ejecutarán después de que se haya 
     *      creado una instancia del modelo, pero antes de que se haya guardado en la base de datos.
     * 
     * 'afterCreating' se utiliza para definir acciones que se ejecutarán después de que se haya 
     *      creado una instancia del modelo y esta haya sido guardada en la base de datos.
     */
