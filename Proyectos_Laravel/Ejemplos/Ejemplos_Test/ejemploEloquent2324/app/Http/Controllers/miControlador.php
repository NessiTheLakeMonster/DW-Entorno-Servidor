...
class miControlador extends Controller
{
    ...
    public function verPersonasCoche() {
     ...
     public function borrarPersona($dni){
         $result=Persona::where('DNI',$dni)->delete();
         if ($result == 0){
                 $mens = "No encontrado";
                 return response()->json(['mens' => $mens],203);
            } 
            else {
                $mens = "Borrado";
                return response()->json(['mens' => $mens],200);
        }
    }
...
//        }
    ...
    public function probarBelong() {
        ...
        //$coches = Propiedad::with(['usuarios','coches'])->get();
     ...
     public function verComentarios(){
        ...
        $comentarios = Comentario::with(['usuarios'])->where('DNI','7G')->get();
